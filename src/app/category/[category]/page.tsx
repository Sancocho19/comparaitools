          ...
          {catTools
            ...
            .map((tool, i) => (
              <Link key={tool.id} href={`/tools/${tool.slug}`}>
                <div
                  className="rounded-2xl p-5 md:p-6 flex items-center gap-5 transition-all hover:scale-[1.01]"
                  style={{
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3">
                      ...
                      {i === 0 && (
                        <span className="text-[10px] px-2 py-0.5 rounded-full font-bold" style={{ background: "var(--accent)", color: "var(--bg)" }}>TOP PICK</span>
                      )}
                    </div>
