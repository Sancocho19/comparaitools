...
export default async function ToolPage({
  ...
  const faqs = [
    {
      q: `What is ${tool.name} positioned for in 2026?`,
      a: `${tool.name} is positioned for ${bestFor || 'general AI work'} and currently shows pricing at ${compactPriceText(tool.pricing)}. The overall profile centers on ${features.slice(0, 2).join(' and ') || tool.categoryLabel.toLowerCase()}.`,
    },
    {
    ...
    <>
      ...
      <main className="max-w-[860px] mx-auto px-6 md:px-8 py-12 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[var(--text-muted)] text-sm max-w-[760px] mx-auto">Pricing, pros, cons, alternatives, positioning, and research status for {tool.name}.</p>
        ...
        {companionPosts.length > 0 ? (
          <section className="rounded-2xl p-6 md:p-8 mb-6" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
            <h2 className="text-lg font-bold text-[var(--text)] mb-4">Related coverage</h2>
